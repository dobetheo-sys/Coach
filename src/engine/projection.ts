...
export interface ProjectionInput {
  ...
  tests?: RefTest[];
  /**
   * O-68 §3 — part ÉCOULÉE du plan (0..1), `semaines écoulées / semaines totales`. Ce qui varie
   * avec la position n'est pas l'adhérence : c'est ce qu'on en SAIT. À S1 elle ne prédit rien
   * des 39 semaines restantes ; à S39 elle prédit presque tout. Absente = poids plein (l'ancien
   * comportement, conservé pour tout appelant qui ne connaît pas sa position).
   */
