...
// Le bloc `extractTrialAngles` (6 tests) est retiré avec la fonction qu'il couvrait — voir
// la note dans `captureProcessing.ts`. 56 tests portés sur les 70 du dépôt d'origine :
// 6 ici, 3 pour `pose-integration` (mort aussi) et 5 pour la segmentation MediaPipe,
// qui ne peut pas être portée sans la dépendance (voir le rapport d'intégration).
