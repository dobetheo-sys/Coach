...
export function microDefiHTML(plan, todayISO) {
  ...
  return '<div class="load-card" style="border-color:var(--zn-gold,var(--gold));border-width:3px;background:var(--zn-bg-eve,#fff8e6)">'
    + '<div class="load-title" style="color:var(--zn-gold,var(--gold))">🎯 Micro-défi du jour <span style="font-weight:400;color:var(--zn-muted,var(--muted));font-size:var(--fs-xs)">— zéro volume en plus</span></div>'
