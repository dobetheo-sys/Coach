...
- **budget** · Séances par semaine : `6` — Le plus petit des deux : ce que tu as déclaré, et ce que ton volume permet (10.0 h à répartir, environ 1.2 h par séance)
...
- **courbe** · Courbe de charge : `base 0.5→pic 1.0→affûtage 0.3` — La charge monte vers le pic puis redescend avant la course ; les semaines de décharge valent 62 % de leurs voisines, et le plan ne monte jamais de plus de 10 % d'une semaine à l'autre
