...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| tri | 108 | 0.97 | 0.91–0.99 | 0 | 0 | 0 | 0.44 | 0 | 0 | 0.0 | 100% | 96 |
...
- Saut >+10% de la courbe déclarée entre semaines de charge : **26** combinaisons en échec
...
- Répartition des intensités : part facile <70% : **2** en échec (médiane 86% de temps facile)
...
- **tri** : S/reprise/inter/plaisir → ratio 0.90 (déclaré 4.0h, prescrit 3.6h), longue 35%
