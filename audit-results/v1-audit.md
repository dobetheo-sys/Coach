...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| tri | 108 | 0.98 | 0.92–0.99 | 0 | 0 | 0 | 0.40 | 0 | 0 | 0.0 | 100% | 96 |
...
- Saut >+10% de la courbe déclarée entre semaines de charge : **32** combinaisons en échec
...
- Répartition des intensités : part facile <70% : **4** en échec (médiane 86% de temps facile)
