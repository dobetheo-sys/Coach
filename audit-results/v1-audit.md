...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| tri | 108 | 0.98 | 0.94–1.00 | 0 | 0 | 0 | 0.43 | 0 | 3 | 0.0 | 100% | 96 |
...
- Répartition des intensités : part facile <70% : **0** en échec (médiane 86% de temps facile)
...
- **tri** : M/confirme/debutant/competition → ratio 0.89 (déclaré 6.0h, prescrit 5.3h), longue 43%
