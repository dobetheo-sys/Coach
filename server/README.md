...
- Scopes demandés : `activity:read_all` (les séances) et `profile:read_all` (la **FTP
  déclarée** dans le profil Strava — voir O-22 : l'estimer depuis les activités donnait
  188 W pour 230 réels). Les deux sont en LECTURE SEULE : l'app n'écrit jamais sur Strava.
