...
const DETTES = {
  ...
  "MONO-swim-css-debutant": "O-83 — EXACTEMENT la discontinuité mesurée en fiche 54 (A.4a) : à CSS≈2:06, la détente `swimCapDebutantM` s'enclenche et le nageur LENT reçoit une séance plus grosse. Fermeture attendue par la tâche 2 de la fiche 55.",
  "MONO-swim-vol_max-debutant": "O-83 — EXACTEMENT l'inversion mesurée en fiche 54 (A.3) : au-delà de 8h, `vol_max` ne change plus rien pour un nageur débutant, et 5h peut livrer plus que 9h. Fermeture attendue par la tâche 2 de la fiche 55.",
