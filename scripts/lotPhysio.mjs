...
// CORPUS ÉLARGI (fiche 37, 25/08/2026) — +30 profils (16 à drapeau médical, 14 à référence
...
// CORPUS ÉLARGI (fiche 37) — la population tri passe de 195 à 203 : +4 profils `MED/tri` et
...
T("T-60", "rouge", "le plancher de fréquence : jamais zéro discipline · 2 tenu là où le budget le permet · la cible publiée", () => {
  ...
  // ENTRÉE DE PLAN DU DÉBUTANT (21/08/2026) — 30 → **8**, une BAISSE de 22. Les DEUX producteurs
  // des semaines sans nage sont fermés : la coupe du plancher piscine et le repli « dev <= pic »
  // consultent désormais le niveau ZÉRO. Il ne reste que les 8 semaines de COURSE de
