...
const ROUGES_ATTENDUS = {
  "T-60": "O-98 — les **30 semaines à ZÉRO** se lisent en DEUX populations, mesurées le 21/08 sur la suite calendaire (question du fondateur : « une semaine sans vélo est un accident, trois de suite sans nage est un trou »). **COURSE : 8 semaines, un seul profil (`G/tri/Full/vol-min`, 3 séances/sem), JAMAIS deux de suite** — un accident au sens exact. **VÉLO : zéro** (les zéros vélo du corpus sont tous en récup). **NAGE : 22 semaines, 14 profils, TOUTES au DÉBUT (S1-S3), tous débutants, formats S et M** — jusqu'à 4 semaines d'affilée sans une seule nage, et les deux profils concernés sont ceux dont la continuité est déclarée « inconnue » ou « absente » : leur première séance de natation est un 500 m continu en EAU LIBRE en semaine 5. Ce n'est donc pas une dispersion mais une entrée de plan à revoir pour une population nommée, en amont de l'allocation — dans ce que B-17 pose AVANT son test. Aucune des 30 ne porte de drapeau médical, de blessure ni de douleur. Cliquet posé à 30 : il ne peut plus monter.",
