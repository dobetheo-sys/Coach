...
const ORDER = [
  ...
  // B1 — l'agrégation des décisions. Fonctions PURES, aucune dépendance sur le reste du
  // bundle : son rang n'a d'importance que d'être AVANT `bridge`, son unique appelant.
  "src/engine/agregerDecisions.ts",
