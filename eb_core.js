...
function buildPlan(a){
  ...
  function sess(slot,phase,prog){
    ...
    if(sp==="run"){
      ...
      // Angle mort couvert : la nage-volume tri n'a pas le drapeau `long`, mais on la borne
      // par clé discipline+rôle (bnd sur le bloc-volume) — plancher/plafond progressif comme
      // les autres séances de volume, source unique. Plafond = max d'entraînement nage tri.
