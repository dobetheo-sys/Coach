...
5. ~~Brancher l'UI de Coach_Pro_V1.5.html sur le moteur V2~~ ✅ bundle EBV2 auto-testé
   (`npm run build:app`), carte « Forme du jour », décisions du moteur affichées,
   legacy en repli, garde `check:app` en CI
