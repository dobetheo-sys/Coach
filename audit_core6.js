#!/usr/bin/env node
/* ============================================================================
   EnduraBuild — SUITE DE RÉGRESSION v6  (remplace v5 : ajoute C12-C14, plafonds & rendu)
   Usage :  node audit_v6.js [chemin/vers/Coach_Pro_Vx_x_x.html]
...
const ENG=require('./eb_core.js'); ENG.S={}; const _bp=ENG.buildPlan; ENG.buildPlan=a=>_bp(Object.assign({sport:ENG.S.sport},a));
